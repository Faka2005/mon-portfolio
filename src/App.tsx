...
import ProjectDetailsWeb from "./components/ProjectDetailWeb";
import ProjectDetailsIoT from "./components/ProectDetailsIot";
const App: React.FC = () => {
  return (
    <Router>
      <NavbarComponent />
      <Routes>
        ...
        <Route path="/project/iot/:name" element={<ProjectDetailsIoT/>}/>
          <Route path="/project/web/:name" element={<ProjectDetailsWeb />} />
